...
interface StorageManager {
     ...
     * @param mediaType The type of media (e.g. "PHOTO", "VIDEO", "AUDIO", "OTHER").
     * @param fileExtension The file extension.
     * @return The URI/path string pointing to the destination.
     */
    fun getDestinationUri(fileId: String, mediaType: String, fileExtension: String): String
     ...
     */
    fun saveMedia(fileId: String, inputStream: InputStream, mediaType: String, fileExtension: String): String
     ...
     */
    fun appendMediaBytes(fileId: String, inputStream: InputStream, offset: Long, mediaType: String, fileExtension: String): Long
     ...
     */
    fun deleteMedia(fileId: String, mediaType: String, fileExtension: String): Boolean
}
