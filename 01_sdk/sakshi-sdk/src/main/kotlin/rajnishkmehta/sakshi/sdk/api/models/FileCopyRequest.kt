 ...
 * @property fileExtension The file extension for the file (e.g. "jpg", "png"). Must be between 1 and 50 characters long, not contain spaces, start/end with a dot, or contain slashes, backslashes, or ".." path traversal sequences.
