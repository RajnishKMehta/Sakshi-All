...
import rajnishkmehta.sakshi.camera.GSlideTransformer
import rajnishkmehta.sakshi.camera.GallerySliderAdapter
import rajnishkmehta.sakshi.camera.ITEM_TYPE_VIDEO
import rajnishkmehta.sakshi.camera.R
import rajnishkmehta.sakshi.camera.databinding.GalleryBinding
import rajnishkmehta.sakshi.camera.editCapturedItem
import rajnishkmehta.sakshi.camera.shareCapturedItem
import rajnishkmehta.sakshi.camera.util.formatVideoDuration
import rajnishkmehta.sakshi.camera.util.getParcelableArrayListExtra
import rajnishkmehta.sakshi.camera.util.getParcelableExtra
import rajnishkmehta.sakshi.camera.util.storageLocationToUiString
